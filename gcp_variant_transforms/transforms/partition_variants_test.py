...
class PartitionVariantsTest(unittest.TestCase):
  ...
  def _get_standard_variants(self):
    ...
    variants = []
    # Partition 0
    variants.append(vcfio.Variant(reference_name='chr1'))
    variants.append(vcfio.Variant(reference_name='CHR1'))
    # Partition 1
    variants.append(vcfio.Variant(reference_name='cHr2'))
    variants.append(vcfio.Variant(reference_name='chR2'))
    # Partition 2
    variants.append(vcfio.Variant(reference_name='chr3'))
    variants.append(vcfio.Variant(reference_name='chr03'))
    # Partition 5
    variants.append(vcfio.Variant(reference_name='6'))
    variants.append(vcfio.Variant(reference_name='06'))
    variants.append(vcfio.Variant(reference_name='chr06'))
    # Partition 9
    variants.append(vcfio.Variant(reference_name='chr10'))
    variants.append(vcfio.Variant(reference_name='  chr10   '))
    # Partition 21
    variants.append(vcfio.Variant(reference_name='chr22'))
    variants.append(vcfio.Variant(reference_name='chr22    '))
    return variants, variants[0:2], variants[2:4], variants[4:6], variants[6:9], variants[9:11], variants[11:13]

  def _get_nonstandard_variants(self):
    variants = []
    variants.append(vcfio.Variant(reference_name='NOTchr1'))
    variants.append(vcfio.Variant(reference_name='NOTch3'))
    variants.append(vcfio.Variant(reference_name='NOTc4'))
    variants.append(vcfio.Variant(reference_name='NOT6'))
    variants.append(vcfio.Variant(reference_name='NOT07'))
    variants.append(vcfio.Variant(reference_name='chr008'))
    variants.append(vcfio.Variant(reference_name='chr010'))
    variants.append(vcfio.Variant(reference_name='chr0'))
    variants.append(vcfio.Variant(reference_name='chr23'))
    variants.append(vcfio.Variant(reference_name='chr99'))
    variants.append(vcfio.Variant(reference_name='chrX'))
    variants.append(vcfio.Variant(reference_name='chrY'))
    variants.append(vcfio.Variant(reference_name='chrM'))
  ...
  def test_partition_variants(self):
    standard_variants, par00, par01, par02, par05, par09, par21  = self._get_standard_variants()
    ...
    partitions = (
        ...
        | 'PartitionVariants' >> Partition(
            partition_variants.PartitionVariants(), 22 + 1))
