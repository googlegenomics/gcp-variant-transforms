...
class GetSampleNamesTest(unittest.TestCase):
  ...
  def _sample_name_with_file(self, sample_name, file_path):
    return "{}/{}".format(file_path, sample_name)

  def test_get_sample_names_with_file(self):
    hash_dict = {1: ('N01', 'file1'),
                 2: ('N02', 'file1'),
                 3: ('N01', 'file2'),
                 4: ('N02', 'file2')}
    sample_ids = [1, 2, 3, 4]
    expected_sample_names = [self._sample_name_with_file('N01', 'file1'),
                             self._sample_name_with_file('N02', 'file1'),
                             self._sample_name_with_file('N01', 'file2'),
                             self._sample_name_with_file('N02', 'file2')]
  ...
  def test_get_sample_names_without_file(self):
    hash_dict = {1: ('N01', 'file1'),
                 2: ('N02', 'file2')}
    sample_ids = [1, 2]
    expected_sample_names = ['N01', 'N02']
