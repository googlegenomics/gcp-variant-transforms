...
class QueryFormatter(object):
  ...
  class _QueryMacros(enum.Enum):
    COUNT_AA_INFO_FIELD_QUERY = 'SELECT COUNT(AA) AS cnt FROM {TABLE_NAME}'
    COUNT_AF_INFO_FIELD_QUERY = 'SELECT COUNT(AF) AS cnt FROM {TABLE_NAME}'
    COUNT_DB_INFO_FIELD_QUERY = 'SELECT COUNT(DB) AS cnt FROM {TABLE_NAME}'
    COUNT_DP_INFO_FIELD_QUERY = 'SELECT COUNT(DP) AS cnt FROM {TABLE_NAME}'
    COUNT_H2_INFO_FIELD_QUERY = 'SELECT COUNT(H2) AS cnt FROM {TABLE_NAME}'
    COUNT_NS_INFO_FIELD_QUERY = 'SELECT COUNT(NS) AS cnt FROM {TABLE_NAME}'
    ...
    SUM_DB_INFO_FIELD_QUERY = 'SELECT SUM(DB) AS sum FROM {TABLE_NAME}'
    SUM_NS_INFO_FIELD_QUERY = 'SELECT SUM(NS) AS sum FROM {TABLE_NAME}'
