...
from gcp_variant_transforms.libs.annotation.vep import vep_runner_old
...
class VepRunnerTest(unittest.TestCase):
  ...
  def _create_test_instance(self, pipeline_args=None):
    # type: (List[str]) -> vep_runner_old.VepRunner
    test_object = vep_runner_old.VepRunner(
  ...
  def test_make_vep_cache_path(self):
    ...
    test_instance = vep_runner_old.VepRunner(
...
class GetBaseNameTest(unittest.TestCase):
  def test_get_base_name(self):
    self.assertEqual('t.vcf', vep_runner_old._get_base_name('a/b/t.vcf'))
    self.assertEqual('t.vcf', vep_runner_old._get_base_name('/a/b/t.vcf'))
    self.assertEqual('t.vcf', vep_runner_old._get_base_name('gs://a/b/t.vcf'))
    self.assertEqual('t.vcf', vep_runner_old._get_base_name('a/b/t.vcf'))
