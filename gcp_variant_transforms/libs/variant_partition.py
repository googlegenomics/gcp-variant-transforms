...
class VariantPartition(object):
  ...
  def _get_auto_partition(self, reference_name):
    ...
    range. In order to make this look up less computation intensive we follow:
      1) Look up the reference_name in _reference_name_to_partition_map dict
    ...
    result will be added to _reference_name_to_partition_map for future look up.
